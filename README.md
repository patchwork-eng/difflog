...
> **Generate a human-readable CHANGELOG.md from your git commits — powered by AI.**
>
...
|-------|----------|---------|-------------|
| `openai_key` | ✅ | — | Your OpenAI API key (store as a secret) |
| `model` | ❌ | `gpt-4o-mini` | OpenAI model to use |
| `max_commits` | ❌ | `50` | Max commits to analyze |
...
3. Push to `main` — your `CHANGELOG.md` will be auto-generated
