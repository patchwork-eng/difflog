...
|-------|----------|---------|-------------|
| `openai_key` | Γ£à | ΓÇö | Your OpenAI API key (store as a secret) |
| `model` | Γ¥î | `gpt-4o-mini` | OpenAI model to use |
| `max_commits` | Γ¥î | `50` | Max commits to analyze |
...
3. Push to `main` ΓÇö your `CHANGELOG.md` will be auto-generated
